...
void SwEditWin::Command( const CommandEvent& rCEvt )
{
    ...
    {
#ifdef USE_JAVA
        pQuickHlpData->sLastExtText = String();
        pQuickHlpData->bExtTextEnabled = FALSE;
#endif	// USE_JAVA
        SwWrtShell &rSh = rView.GetWrtShell();
        BOOL bIsDocReadOnly = rView.GetDocShell()->IsReadOnly() &&
                              rSh.IsCrsrReadonly();
    ...
    {
#ifdef USE_JAVA
        String sWord = pQuickHlpData->sLastExtText;
        pQuickHlpData->sLastExtText = String();
        pQuickHlpData->bExtTextEnabled = TRUE;
#endif	// USE_JAVA
        SwWrtShell &rSh = rView.GetWrtShell();
        BOOL bIsDocReadOnly = rView.GetDocShell()->IsReadOnly() &&
                              rSh.IsCrsrReadonly();
...
#ifdef USE_JAVA
            pQuickHlpData->sLastExtText = sWord;
#endif	// USE_JAVA
...
#ifdef USE_JAVA
	// Fix bug 200 by turning off autocompletion when input methods are being
	// dispatched
	else if ( bExtTextEnabled )
#else	// USE_JAVA
	else
#endif	// USE_JAVA
	{
