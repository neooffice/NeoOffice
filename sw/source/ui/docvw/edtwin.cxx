                ...
                if (!pApplyTempl)
                {
...
#if defined USE_JAVA && defined MACOSX
                    {
                        ...
                        if ( pPopupMenuManager )
                        {
                            ...
                            ((PopupMenu *)pPopupMenuManager->GetSVMenu())->EnableItem( FN_LOOKUP_IN_MACOSX_DICTIONARY, sal_False );
                            ...
                            if ( pOLV )
                            {
                                ...
                                if ( aText.Len() )
                                    ((PopupMenu *)pPopupMenuManager->GetSVMenu())->EnableItem( FN_LOOKUP_IN_MACOSX_DICTIONARY, sal_True );
                            }
                            else
                            {
