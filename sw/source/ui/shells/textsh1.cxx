	...
	while ( nWhich )
	{
		...
		{				
            ...
            case SID_ATTR_CHAR_FILLCOLOR:
            {
                ...
                if ( SFX_ITEM_SET == aCoreSet.GetItemState( SID_BACKGROUND_COLOR, sal_True, &pTmpItem ) )
                    aColor = ((SvxColorItem *)pTmpItem)->GetValue();
                else if ( SFX_ITEM_SET == aCoreSet.GetItemState( RES_CHRATR_BACKGROUND, sal_True, &pTmpItem ) )
