...
#ifdef USE_JAVA
			// Fix crashing bug found in the sample Writer document in bug
			// 3617. When opening the embedded Draw object in that sample
			// document and then printing only the selection, the node will
			// be NULL.
			if ( pCNd && SwClientIter( *pCNd ).First( TYPE(SwFrm) ) )
#else	// USE_JAVA
