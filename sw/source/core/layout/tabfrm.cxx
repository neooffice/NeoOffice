 ...
 *
 * Modified January 2016 by Patrick Luby. NeoOffice is distributed under
...
#ifdef USE_JAVA
                // Do not move SwAnchoredDrawObject instances out of range as
                // that causes shapes that were inserted from the Drawing
                // toolbar and that are anchored in the half of a table cell
                // that has been split onto a following page to be moved to the
                // right edge of the page
                if ( _bMoveObjsOutOfRange && !pAnchoredObj->ISA( SwAnchoredDrawObject ) )
#else	// USE_JAVA
