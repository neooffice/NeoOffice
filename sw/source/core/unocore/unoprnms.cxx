...
#if SUPD == 310
/* UNO_NAME_CELL_INTEROP_GRAB_BAG */ {MAP_CHAR_LEN("CellInteropGrabBag")},
/* UNO_NAME_CHAR_BORDER_DISTANCE */ {MAP_CHAR_LEN("CharBorderDistance")},
/* UNO_NAME_CHAR_BOTTOM_BORDER */ {MAP_CHAR_LEN("CharBottomBorder")},
/* UNO_NAME_CHAR_BOTTOM_BORDER_DISTANCE */ {MAP_CHAR_LEN("CharBottomBorderDistance")},
/* UNO_NAME_CHAR_HIGHLIGHT */ {MAP_CHAR_LEN("CharHighlight")},
/* UNO_NAME_CHAR_INTEROP_GRAB_BAG */ {MAP_CHAR_LEN("CharInteropGrabBag")},
/* UNO_NAME_CHAR_LEFT_BORDER */ {MAP_CHAR_LEN("CharLeftBorder")},
/* UNO_NAME_CHAR_LEFT_BORDER_DISTANCE */ {MAP_CHAR_LEN("CharLeftBorderDistance")},
/* UNO_NAME_CHAR_RIGHT_BORDER */ {MAP_CHAR_LEN("CharRightBorder")},
/* UNO_NAME_CHAR_RIGHT_BORDER_DISTANCE */ {MAP_CHAR_LEN("CharRightBorderDistance")},
/* UNO_NAME_CHAR_SHADING_VALUE */ {MAP_CHAR_LEN("CharShadingValue")},
/* UNO_NAME_CHAR_SHADOW_FORMAT */ {MAP_CHAR_LEN("CharShadowFormat")},
/* UNO_NAME_CHAR_TOP_BORDER */ {MAP_CHAR_LEN("CharTopBorder")},
/* UNO_NAME_CHAR_TOP_BORDER_DISTANCE */ {MAP_CHAR_LEN("CharTopBorderDistance")},
/* UNO_NAME_DEFAULT_PAGE_MODE */ {MAP_CHAR_LEN("DefaultPageMode")},
/* UNO_NAME_DESCRIPTION */ {MAP_CHAR_LEN("Description")},
/* UNO_NAME_DOC_INTEROP_GRAB_BAG */ {MAP_CHAR_LEN("InteropGrabBag")},
/* UNO_NAME_EMBEDDED_OBJECT */ {MAP_CHAR_LEN("EmbeddedObject")},
/* UNO_NAME_FILL_GRADIENT */ {MAP_CHAR_LEN("FillGradient")},
/* UNO_NAME_FILL_GRADIENT_NAME */ {MAP_CHAR_LEN("FillGradientName")},
/* UNO_NAME_FILL_STYLE */ {MAP_CHAR_LEN("FillStyle")},
/* UNO_NAME_FIRST_IS_SHARED */ {MAP_CHAR_LEN("FirstIsShared")},
/* UNO_NAME_FOOTER_TEXT_FIRST */ {MAP_CHAR_LEN("FooterTextFirst")},
/* UNO_NAME_FOOTNOTE_LINE_STYLE */ {MAP_CHAR_LEN("FootnoteLineStyle")},
/* UNO_NAME_FRAME_INTEROP_GRAB_BAG */ {MAP_CHAR_LEN("FrameInteropGrabBag")},
/* UNO_NAME_HEADER_TEXT_FIRST */ {MAP_CHAR_LEN("HeaderTextFirst")},
/* UNO_NAME_HIDDEN */ {MAP_CHAR_LEN("Hidden")},
/* UNO_NAME_HIDE_TAB_LEADER_AND_PAGE_NUMBERS */ {MAP_CHAR_LEN("HideTabLeaderAndPageNumber")},
/* UNO_NAME_INDEX_ENTRY_TYPE */ {MAP_CHAR_LEN("IndexEntryType")},
/* UNO_NAME_INITIALS */ {MAP_CHAR_LEN("Initials")},
/* UNO_NAME_LINE_STYLE */ {MAP_CHAR_LEN("LineStyle")},
/* UNO_NAME_LINE_WIDTH */ {MAP_CHAR_LEN("LineWidth")},
/* UNO_NAME_META */ {MAP_CHAR_LEN("InContentMetadata")},
/* UNO_NAME_NESTED_TEXT_CONTENT */ {MAP_CHAR_LEN("NestedTextContent")},
/* UNO_NAME_PARAGRAPH_STYLE_NAME */ {MAP_CHAR_LEN("ParagraphStyleName")},
/* UNO_NAME_PARA_CONTEXT_MARGIN */ {MAP_CHAR_LEN("ParaContextMargin")},
/* UNO_NAME_PARA_INTEROP_GRAB_BAG */ {MAP_CHAR_LEN("ParaInteropGrabBag")},
/* UNO_NAME_PARRSID */ {MAP_CHAR_LEN("ParRsid")},
/* UNO_NAME_RELATIVE_HEIGHT_RELATION */ {MAP_CHAR_LEN("RelativeHeightRelation")},
/* UNO_NAME_RELATIVE_WIDTH_RELATION */ {MAP_CHAR_LEN("RelativeWidthRelation")},
/* UNO_NAME_REPLACEMENT_GRAPHIC_URL */ {MAP_CHAR_LEN("ReplacementGraphicURL")},
/* UNO_NAME_RSID */ {MAP_CHAR_LEN("Rsid")},
/* UNO_NAME_SEPARATOR_LINE_STYLE */ {MAP_CHAR_LEN("SeparatorLineStyle")},
/* UNO_NAME_SHADOW_TRANSPARENCE */ {MAP_CHAR_LEN("ShadowTransparence")},
/* UNO_NAME_STYLE_INTEROP_GRAB_BAG */ {MAP_CHAR_LEN("StyleInteropGrabBag")},
/* UNO_NAME_TABLE_BORDER2 */ {MAP_CHAR_LEN("TableBorder2")},
/* UNO_NAME_TABLE_INTEROP_GRAB_BAG */ {MAP_CHAR_LEN("TableInteropGrabBag")},
/* UNO_NAME_TAB_IN_TOC */ {MAP_CHAR_LEN("TabInTOC")},
/* UNO_NAME_TEXT_VERT_ADJUST */ {MAP_CHAR_LEN("TextVerticalAdjust")},
/* UNO_NAME_TOC_BOOKMARK */ {MAP_CHAR_LEN("TOCBookmark")},
/* UNO_NAME_TOC_NEWLINE */ {MAP_CHAR_LEN("TOCNewLine")},
/* UNO_NAME_TOC_PARAGRAPH_OUTLINE_LEVEL */ {MAP_CHAR_LEN("TOCParagraphOutlineLevel")},
//UUUU names for FillAttributes from SVX
/* UNO_NAME_SW_FILLBMP_LOGICAL_SIZE */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_LOGICAL_SIZE)},
/* UNO_NAME_SW_FILLBMP_OFFSET_X */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_OFFSET_X)},
/* UNO_NAME_SW_FILLBMP_OFFSET_Y */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_OFFSET_Y)},
/* UNO_NAME_SW_FILLBMP_POSITION_OFFSET_X */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_POSITION_OFFSET_X)},
/* UNO_NAME_SW_FILLBMP_POSITION_OFFSET_Y */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_POSITION_OFFSET_Y)},
/* UNO_NAME_SW_FILLBMP_RECTANGLE_POINT */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_RECTANGLE_POINT)},
/* UNO_NAME_SW_FILLBMP_SIZE_X */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_SIZE_X)},
/* UNO_NAME_SW_FILLBMP_SIZE_Y */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_SIZE_Y)},
/* UNO_NAME_SW_FILLBMP_STRETCH */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_STRETCH)},
/* UNO_NAME_SW_FILLBMP_TILE */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_TILE)},
/* UNO_NAME_SW_FILLBMP_MODE */ {MAP_CHAR_LEN(UNO_NAME_FILLBMP_MODE)},
/* UNO_NAME_SW_FILLCOLOR */ {MAP_CHAR_LEN(UNO_NAME_FILLCOLOR)},
/* UNO_NAME_SW_FILLBACKGROUND */ {MAP_CHAR_LEN(UNO_NAME_FILLBACKGROUND)},
/* UNO_NAME_SW_FILLBITMAP */ {MAP_CHAR_LEN(UNO_NAME_FILLBITMAP)},
/* UNO_NAME_SW_FILLBITMAPNAME */ {MAP_CHAR_LEN(UNO_NAME_FILLBITMAPNAME)},
/* UNO_NAME_SW_FILLBITMAPURL */ {MAP_CHAR_LEN(UNO_NAME_FILLBITMAPURL)},
/* UNO_NAME_SW_FILLGRADIENTSTEPCOUNT */ {MAP_CHAR_LEN(UNO_NAME_FILLGRADIENTSTEPCOUNT)},
/* UNO_NAME_SW_FILLGRADIENT */ {MAP_CHAR_LEN(UNO_NAME_FILLGRADIENT)},
/* UNO_NAME_SW_FILLGRADIENTNAME */ {MAP_CHAR_LEN(UNO_NAME_FILLGRADIENTNAME)},
/* UNO_NAME_SW_FILLHATCH */ {MAP_CHAR_LEN(UNO_NAME_FILLHATCH)},
/* UNO_NAME_SW_FILLHATCHNAME */ {MAP_CHAR_LEN(UNO_NAME_FILLHATCHNAME)},
/* UNO_NAME_SW_FILLSTYLE */ {MAP_CHAR_LEN(UNO_NAME_FILLSTYLE)},
/* UNO_NAME_SW_FILL_TRANSPARENCE */ {MAP_CHAR_LEN(UNO_NAME_FILL_TRANSPARENCE)},
/* UNO_NAME_SW_FILLTRANSPARENCEGRADIENT */ {MAP_CHAR_LEN(UNO_NAME_FILLTRANSPARENCEGRADIENT)},
/* UNO_NAME_SW_FILLTRANSPARENCEGRADIENTNAME */ {MAP_CHAR_LEN(UNO_NAME_FILLTRANSPARENCEGRADIENTNAME)},
/* UNO_NAME_SW_FILLCOLOR_2 */ {MAP_CHAR_LEN(UNO_NAME_FILLCOLOR_2)},
/* UNO_NAME_TEXT_BOX */ {MAP_CHAR_LEN("TextBox")},
/* UNO_NAME_CHAIN_NAME */ {MAP_CHAR_LEN("ChainName")},
/* UNO_NAME_ROW_INTEROP_GRAB_BAG */ {MAP_CHAR_LEN("RowInteropGrabBag")},
#endif	// SUPD == 310
};
