...
/* #if SUPD == 310 */ \
    ...
    { SW_PROP_NMID(UNO_NAME_FILL_GRADIENT), RES_FILL_GRADIENT,      CPPU_E2T(&::getCppuType((css::awt::Gradient*)0)), PROPERTY_NONE ,MID_FILLGRADIENT}, \
    { SW_PROP_NMID(UNO_NAME_FILL_GRADIENT_NAME), RES_FILL_GRADIENT, CPPU_E2T(CPPUTYPE_OUSTRING), PROPERTY_NONE ,MID_NAME}, \
    { SW_PROP_NMID(UNO_NAME_FILL_STYLE), RES_FILL_STYLE,      CPPU_E2T(&::getCppuType((css::drawing::FillStyle*)0)), PROPERTY_NONE ,0}, \
    { SW_PROP_NMID(UNO_NAME_FRAME_INTEROP_GRAB_BAG), RES_FRMATR_GRABBAG, CPPU_E2T(CPPUTYPE_PROPERTYVALUE), PROPERTY_NONE, 0}, \
    { SW_PROP_NMID(UNO_NAME_LINE_STYLE), RES_BOX, CPPU_E2T(&::getCppuType((css::drawing::LineStyle*)0)),  0, LINE_STYLE }, \
...
#if SUPD == 310
                    { SW_PROP_NMID(UNO_NAME_CELL_INTEROP_GRAB_BAG), RES_FRMATR_GRABBAG, CPPU_E2T(CPPUTYPE_PROPERTYVALUE), PROPERTY_NONE, 0 },
#endif	// SUPD == 310
                    _REDLINE_NODE_PROPERTIES
                    {0,0,0,0,0,0}
				};
...
//                    { SW_PROP_NMID(UNO_NAME_BOTTOM_BORDER_DISTANCE), RES_BOX,               CPPU_E2T(CPPUTYPE_INT32),   0, BOTTOM_BORDER_DISTANCE|CONVERT_TWIPS },
...
#if SUPD == 310
                    { SW_PROP_NMID(UNO_NAME_INDEX_ENTRY_TYPE), WID_INDEX_ENTRY_TYPE, CPPU_E2T(CPPUTYPE_OUSTRING), PROPERTY_NONE, 0},
#endif	// SUPD == 310
                    {0,0,0,0,0,0}
				};
			...
			case PROPERTY_MAP_INDEX_CNTNT:
			{
				...
				//	{ SW_PROP_NMID(UNO_NAME_???                               ), WID_???                                 ,  &_getReflection  , PROPERTY_NONE,     0},
					...
					{ SW_PROP_NMID(UNO_NAME_DOCUMENT_INDEX_MARKS), WID_INDEX_MARKS, CPPU_E2T(CPPUTYPE_DOCIDXMRK),			PropertyAttribute::READONLY ,0		 },
#if SUPD == 310
                    { SW_PROP_NMID(UNO_NAME_HIDE_TAB_LEADER_AND_PAGE_NUMBERS), WID_HIDE_TABLEADER_PAGENUMBERS                   ,  CPPU_E2T(CPPUTYPE_BOOLEAN)  , PROPERTY_NONE,     0},
                    { SW_PROP_NMID(UNO_NAME_TAB_IN_TOC), WID_TAB_IN_TOC, CPPU_E2T(CPPUTYPE_BOOLEAN), PROPERTY_NONE, 0},
                    { SW_PROP_NMID(UNO_NAME_TOC_BOOKMARK), WID_TOC_BOOKMARK, CPPU_E2T(CPPUTYPE_OUSTRING), PROPERTY_NONE, 0},
                    { SW_PROP_NMID(UNO_NAME_TOC_NEWLINE), WID_TOC_NEWLINE, CPPU_E2T(CPPUTYPE_BOOLEAN), PROPERTY_NONE, 0},
                    { SW_PROP_NMID(UNO_NAME_TOC_PARAGRAPH_OUTLINE_LEVEL), WID_TOC_PARAGRAPH_OUTLINE_LEVEL, CPPU_E2T(CPPUTYPE_BOOLEAN), PROPERTY_NONE, 0},
#endif	// SUPD == 310
                    {0,0,0,0,0,0}
				};
