...
#ifdef USE_JAVA
                                // Fix crash when opening .docx file in the
                                // following LibreOffice issue after the table
                                // of contents in the file has been removed
                                // using Microsoft Word by check for NULL:
                                // https://bugs.documentfoundation.org/show_bug.cgi?id=76948
                                if (pHnt)
#endif	// USE_JAVA
