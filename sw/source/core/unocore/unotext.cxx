...
#if SUPD == 310
    const uno::Type& rXTextPortionAppend2 = ::getCppuType((uno::Reference< text::XTextPortionAppend2 >*)0);
#endif	// SUPD == 310
    const uno::Type& rXParagraphAppend = ::getCppuType((uno::Reference< text::XParagraphAppend >*)0);
#if SUPD == 310
    const uno::Type& rXParagraphAppend2 = ::getCppuType((uno::Reference< text::XParagraphAppend2 >*)0);
#endif	// SUPD == 310
    const uno::Type& rXTextContentAppend = ::getCppuType((uno::Reference< text::XTextContentAppend >*)0);
#if SUPD == 310
    const uno::Type& rXTextContentAppend2 = ::getCppuType((uno::Reference< text::XTextContentAppend2 >*)0);
#endif	// SUPD == 310
...
#if SUPD == 310
    else if(rType == rXTextPortionAppend || rType == rXTextPortionAppend2 )
    {
        uno::Reference< XTextPortionAppend2 > xRet = this;
        aRet.setValue(&xRet, rXTextPortionAppend2);
    }
    else if(rType == rXParagraphAppend || rType == rXParagraphAppend2 )
    {
        uno::Reference< XParagraphAppend2 > xRet = this;
        aRet.setValue(&xRet, rXParagraphAppend2 );
    }
#else	// SUPD == 310
...
#if SUPD == 310
    else if(rType == rXTextContentAppend || rType == rXTextContentAppend2 )
    {
        uno::Reference< XTextContentAppend2 > xRet = this;
        aRet.setValue(&xRet, rXTextContentAppend2 );
    }
#else	// SUPD == 310
...
#ifdef DEBUG
    fprintf( stderr, "SwXText::finishParagraphInsert not implemented\n" );
#endif
    return finishOrAppendParagraph(true, rProperties);
}
...
throw (lang::IllegalArgumentException, uno::RuntimeException)
{
    uno::Reference< text::XTextRange > xRet;
#ifdef DEBUG
    fprintf( stderr, "SwXText::insertTextPortion not implemented\n" );
#endif
    return appendTextPortion(rText, rCharacterAndParagraphProperties);
}
...
throw (lang::IllegalArgumentException, uno::RuntimeException)
{
    uno::Reference< text::XTextRange > xRet;
#ifdef DEBUG
    fprintf( stderr, "SwXText::insertTextContentWithProperties not implemented\n" );
#endif
    return appendTextContent(xTextContent, rCharacterAndParagraphProperties);
}
