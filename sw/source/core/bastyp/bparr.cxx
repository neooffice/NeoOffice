...
{
#ifndef NO_LIBO_4_4_BITPTRARRAY_FIX
    if (from != to)
    {
#endif	// !NO_LIBO_4_4_BITPTRARRAY_FIX
...
#ifdef NO_LIBO_4_4_BITPTRARRAY_FIX
	BigPtrArray* pThis = (BigPtrArray*) this;
	USHORT cur = Index2Block( idx );
	BlockInfo* p = ppInf[ cur ];
	pThis->nCur = cur;
#else	// NO_LIBO_4_4_BITPTRARRAY_FIX
    ((BigPtrArray *)this)->nCur = Index2Block( idx );
