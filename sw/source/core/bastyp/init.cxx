...
// TextAttr - Dummies
    ...
    aAttrTab[ RES_TXTATR_METAFIELD - POOLATTR_BEGIN ] =     new SfxVoidItem(RES_TXTATR_METAFIELD);
    ...
    aAttrTab[ RES_TXTATR_ANNOTATION - POOLATTR_BEGIN ]->SetWhich( RES_TXTATR_ANNOTATION );
#else	// USE_JAVA
