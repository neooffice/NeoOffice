...
// TextAttr - Dummies
#if SUPD == 310
    aAttrTab[ RES_TXTATR_META - POOLATTR_BEGIN ] =          NULL;
    aAttrTab[ RES_TXTATR_METAFIELD - POOLATTR_BEGIN ] =     NULL;
    aAttrTab[ RES_TXTATR_INPUTFIELD - POOLATTR_BEGIN ] = new SwFmtFld();
    aAttrTab[ RES_TXTATR_INPUTFIELD - POOLATTR_BEGIN ]->SetWhich( RES_TXTATR_INPUTFIELD );
    aAttrTab[ RES_TXTATR_ANNOTATION - POOLATTR_BEGIN ] = new SwFmtFld();
    aAttrTab[ RES_TXTATR_ANNOTATION - POOLATTR_BEGIN ]->SetWhich( RES_TXTATR_INPUTFIELD );
...
// FrmAttr-Dummies
    ...
    aAttrTab[ RES_TEXT_VERT_ADJUST - POOLATTR_BEGIN ]->SetWhich(RES_TEXT_VERT_ADJUST);
#endif	// SUPD == 310
