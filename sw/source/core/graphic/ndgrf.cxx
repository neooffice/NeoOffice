...
//                SvStream* pStrm = _GetStreamForEmbedGrf( bGraphic );
                ...
                if ( !pStrm && aNewStrmName.Len() )
                {
                    ...
                    ((SwGrfNode *)this)->aNewStrmName.Erase();
                    _GetStreamStorageNames( aStrmName, aPicStgName );
                    refPics = _GetDocSubstorageOrRoot( aPicStgName );
                    pStrm = _GetStreamForEmbedGrf( refPics, aStrmName );
                    ((SwGrfNode *)this)->aNewStrmName = aOldNewStrmName;
                }
#endif	// USE_JAVA
                if ( pStrm )
                {
