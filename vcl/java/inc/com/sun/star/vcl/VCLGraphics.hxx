...
public:
	...
	void				drawGlyphs( long _par0, long _par1, int _par2, sal_GlyphId *_par3, float *_par4, com_sun_star_vcl_VCLFont *_par5, SalColor _par6, int _par7, int _par8, long _par9, long _par10, float _par11 );
