...
public final class VCLEventQueue {
	 ...
	 */
	public void removeCachedEvents(long frame) {
	...
	/**
	 * The <code>PostCommandKeyEvent</code> class is a runnable class used for
	 * posting <code>VCLEventQueue.CommandKeyEvent</code> event in the Java
	 * event dispatch thread from the native event dispatch thread without
	 * blocking.
	 */
	static class PostCommandKeyEvent extends VCLEventQueue.PostEmptyEvent implements Runnable {
		...
		/**
		 * Construct a <code>PostCommandKeyEvent</code>.
		 *
