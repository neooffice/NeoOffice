...
/** 
 * A Java class that implements the <code>MRJOpenDocumentHandler</code>
 * interface.
 * <p>
 * @version 	$Revision$ $Date$
 * @author 	    $Author$
 */
public class VCLOpenDocumentHandler implements MRJOpenDocumentHandler {
	...
	/**
	 * Constructs a new <code>VCLOpenDocumentHandler</code> instance.
	 * 
	 * @param q the event queue to post events to
	 */
	public VCLOpenDocumentHandler(VCLEventQueue q) {

		queue = q;

		// Register an instance of this class as the open document handler
