...
/** 
 * A Java class that implements the <code>MRJQuitHandler</code> interface.
 * <p>
 * @version 	$Revision$ $Date$
 * @author 	    $Author$
 */
public class VCLQuitHandler implements MRJQuitHandler {
	...
	/**
	 * Constructs a new <code>VCLQuitHandler</code> instance.
	 * 
	 * @param q the event queue to post events to
	 */
	public VCLQuitHandler(VCLEventQueue q) {
	 ...
	 *
	 * @exception IllegalStateException thrown to cancel to the quit operation
	 */
