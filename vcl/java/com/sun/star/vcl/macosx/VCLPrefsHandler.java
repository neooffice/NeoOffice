...
/** 
 * A Java class that implements the <code>MRJPrefsHandler</code> interface.
 * <p>
 * @version 	$Revision$ $Date$
 * @author 	    $Author$
 */
public class VCLPrefsHandler implements MRJPrefsHandler {
	...
	/**
	 * Constructs a new <code>VCLPrefsHandler</code> instance.
	 * 
	 * @param q the event queue to post events to
	 */
	public VCLPrefsHandler(VCLEventQueue q) {
