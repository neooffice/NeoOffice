...
public final class VCLGraphics {
	...
	static {
		...
		try {
			drawGlyphBufferMethod = VCLGraphics.class.getMethod("drawGlyphBuffer", new Class[]{ int.class, int.class, int.class, long.class, long.class, int.class, float.class, double.class, int.class, int.class, int.class, int.class, int.class, float.class, long.class });
		}
		catch (Throwable t) {
			t.printStackTrace();
		}
	 ...
	 * @param nativeClipPath the native clip path
	 */
	public void drawGlyphBuffer(int x, int y, int count, long glyphs, long advances, int font, float fontSize, double fontScaleX, int color, int orientation, int glyphOrientation, int glyphTranslateX, int glyphTranslateY, float glyphScaleX, long nativeClipPath) {
	 ...
	 * @param scaleY the vertical scale factor
	 */
	native void drawGlyphBuffer0(int x, int y, int count, long glyphs, long advances, int font, float fontSize, int color, int glyphTranslateX, int glyphTranslateY, float glyphRotateAngle, float glyphScaleX, float glyphScaleY, long nativeGlyphBuffer, boolean drawOnMainThread, float translateX, float translateY, float rotateAngle, float scaleX, float scaleY);
	...
	public Rectangle getGlyphBounds(int glyph, VCLFont font, int glyphOrientation) {
		...
		if (g != null) {
			try {
				// Fix bug 3538 by setting font to one point and then scaling
				// to font size
				...
				bounds = new Rectangle2D.Double(bounds.getX() * fontSize, bounds.getY() * fontSize, bounds.getWidth() * fontSize, bounds.getHeight() * fontSize);
			}
			catch (Throwable t) {
				t.printStackTrace();
			}
