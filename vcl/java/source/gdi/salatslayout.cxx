					...
					else if ( bHasFallbackFont )
					{
						...
						if ( !mpFallbackFont )
						{
							...
							if ( !mpFallbackFont )
							{
								...
								// a non-image font that has glyphs for the
								// current char
