...
jclass com_sun_star_vcl_VCLGraphics::getMyClass()
{
	if ( !theClass )
	{
		...
		if ( tempClass )
		{
			...
			pMethods[3].signature = "(IIIJJIIIFFFFFJZFFFFF)V";
...
void com_sun_star_vcl_VCLGraphics::drawGlyphBuffer( int _par0, int _par1, int _par2, CGGlyph *_par3, CGSize *_par4, com_sun_star_vcl_VCLFont *_par5, SalColor _par6, int _par7, int _par8, float _par9, float _par10, float _par11, CGPathRef _par12 )
{
	...
	if ( t.pEnv )
	{
		if ( !mID )
		{
			char *cSignature = "(IIIJJIIDIIIFFFJ)V";
...
void com_sun_star_vcl_VCLGraphics::drawGlyphs( long _par0, long _par1, int _par2, long *_par3, float *_par4, com_sun_star_vcl_VCLFont *_par5, SalColor _par6, int _par7, int _par8, float _par9, float _par10, float _par11 )
{
	static jmethodID mID = NULL;
	VCLThreadAttach t;
	if ( t.pEnv )
