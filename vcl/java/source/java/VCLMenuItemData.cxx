...
jclass com_sun_star_vcl_VCLMenuItemData::theClass = NULL;

// ----------------------------------------------------------------------------

jclass com_sun_star_vcl_VCLMenuItemData::getMyClass()
{
	if ( !theClass )
	{
		VCLThreadAttach t;
		if ( !t.pEnv ) return (jclass)NULL;
		jclass tempClass = t.pEnv->FindClass( "com/sun/star/vcl/VCLMenuItemData" );
...
com_sun_star_vcl_VCLMenuItemData::com_sun_star_vcl_VCLMenuItemData( ::rtl::OUString newTitle, sal_Bool separator, USHORT id, Menu *m ) : java_lang_Object( (jobject)NULL )
{
