 ...
 *  
 *  =================================================
 *  Modified November 2004 by Edward Peterlin. SISSL Removed. NeoOffice is
...
void SystemWindow::SetMenuBarMode( USHORT nMode )
{
    ...
    {
        // [ed] add call to MenuBar object to allow for native menubars to
        // adjust their visibility accordingly.  Bug 205.
        if( mpMenuBar )
            mpMenuBar->MenuBarModeChange( nMode );
        mnMenuBarMode = nMode;
        if ( mpBorderWindow && (mpBorderWindow->GetType() == WINDOW_BORDERWINDOW) )
        {
