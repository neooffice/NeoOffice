 ...
 *
 * Modified June 2016 by Patrick Luby. NeoOffice is distributed under
...
//.........................................................................
	...
	namespace
	{
		...
		public:
			...
			{
				static String aMacOSXString(RTL_CONSTASCII_USTRINGPARAM("Mac OS X"));
				static String aOSXString(RTL_CONSTASCII_USTRINGPARAM("OS X"));
				static String aMacString(RTL_CONSTASCII_USTRINGPARAM("Mac"));
				m_aStrings.reserve(STR_END);
				for (int i = STR_MYSQL_ODBC; i < STR_END ; ++i)
				{
#ifdef USE_JAVA
					String aString(DBA_RES(sal::static_int_cast<USHORT>(i)));
					if (i == STR_MACAB)
					{
						// Replace "Mac OS X" and "OS X" with "Mac"
						aString.SearchAndReplaceAll(aMacOSXString, aMacString);
						aString.SearchAndReplaceAll(aOSXString, aMacString);
					}
					m_aStrings.push_back(aString);
#else	// USE_JAVA
