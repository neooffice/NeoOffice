...
public:
	...
	std::multimap< XubString, sal_uInt16 > aStylesCachedNameMap;
#endif	// USE_JAVA
};
...
sal_Bool SfxStyleSheetBase::SetName( const XubString& rName )
{
	...
	if( aName != rName )
	{
		...
		std::multimap< XubString, sal_uInt16 >::const_iterator snit = rPool.pImp->aStylesCachedNameMap.lower_bound( aName );
		if ( snit != rPool.pImp->aStylesCachedNameMap.end() )
		{
			std::multimap< XubString, sal_uInt16 >::const_iterator ubsnit = rPool.pImp->aStylesCachedNameMap.upper_bound( aName );
...
{
#ifdef USE_JAVA
	std::multimap< XubString, sal_uInt16 >::const_iterator snit = pBasePool->pImp->aStylesCachedNameMap.lower_bound( rStr );
	if ( snit != pBasePool->pImp->aStylesCachedNameMap.end() )
	{
		std::multimap< XubString, sal_uInt16 >::const_iterator ubsnit = pBasePool->pImp->aStylesCachedNameMap.upper_bound( rStr );
