 ...
 *
 * Modified October 2010 by Patrick Luby. NeoOffice is distributed under
...
bool FormulaCompiler::IsOpCodeVolatile( OpCode eOp )
{
    switch (eOp)
    {
        ...
        case ocOffset:
#ifdef USE_JAVA
        // Fix bug 3639 by making comparison operator opcodes volatile
        case ocEqual:
        case ocNotEqual:
        case ocLess:
        case ocGreater:
        ...
        case ocUnion:
        case ocRange:
        // Fix bug 3608 by making the match opcode volatile
        case ocMatch:
#endif	// USE_JAVA
            return true;
    }
