...
#ifdef USE_JAVA
#define	PROPERTYNAME_FONTWYSIWYG_INITED		OUString(RTL_CONSTASCII_USTRINGPARAM("View/ShowFontBoxWYSIWYGInitialized"	))
#endif	// USE_JAVA
...
#ifdef USE_JAVA
	,	m_bFontWYSIWYGInited( sal_False		)
#endif	// USE_JAVA
{
...
void SvtFontOptions_Impl::Notify( const Sequence< OUString >& seqPropertyNames )
{
	...
	for( sal_Int32 nProperty=0; nProperty<nCount; ++nProperty )
	{
		...
		{
			DBG_ASSERT(!(seqValues[nProperty].getValueTypeClass()!=TypeClass_BOOLEAN), "SvtFontOptions_Impl::Notify()\nWho has changed the value type of \"Office.Common\\Font\\View\\ShowFontBoxWYSIWYGInitailized\"?" );
			seqValues[nProperty] >>= m_bFontWYSIWYGInited;
		}
#endif	// USE_JAVA
