...
#	mkdir -p "$(PATCH_INSTALL_HOME)/package/Contents/basis-link/help"
	...
	cd "$(PATCH_INSTALL_HOME)/package/Contents" ; cp "$(PWD)/sc/$(UOUTPUTDIR)/lib/libsc$(DLLSUFFIX).dylib" "$(PWD)/sfx2/$(UOUTPUTDIR)/lib/libsfx$(DLLSUFFIX).dylib" "basis-link/program"
