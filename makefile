...
OO_PRODUCT_VERSION=$(OO_PRODUCT_VERSION_FAMILY).2
...
# increasing versions.
	...
	cd "$(INSTALL_HOME)/package/Contents" ; sed 's#^ProgressPosition=.*$$#ProgressPosition=14,260#g' "program/sofficerc" > "../../out" ; mv -f "../../out" "program/sofficerc" ; ln -sf "../program/sofficerc" "MacOS/sofficerc"
	cd "$(INSTALL_HOME)/package/Contents" ; sh -e -c 'for i in bootstraprc fundamentalrc setuprc versionrc ; do ln -sf "../program/$$i" "MacOS/$$i" ; done'
...
ifeq ("$(PRODUCT_NAME)","NeoOffice")
	cd "$(INSTALL_HOME)/package/Contents" ; rm -f "program/about.bmp" "program/about.png" ; cp "tmp/NeoOffice Aqua Elements 3/Contents/MacOS/about.bmp" "program/about.bmp" ; ln -sf "../program/about.bmp" "MacOS/about.bmp"
ifdef PRODUCT_BUILD3
...
ifeq ("$(PRODUCT_NAME)","NeoOffice")
	...
	chmod -Rf u+rw "$(INSTALL_HOME)/package/Contents/tmp"
	rm -Rf "$(INSTALL_HOME)/package/Contents/tmp"
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/libMacOSXSpell.dylib'
	...
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/libavmediaQuickTime.dylib'
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -register -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/libavmediajava.dylib'
	...
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/fps_aqua.uno.dylib'
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -register -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/fps_java.uno.dylib'
# Reregister spellchecker to enable native grammarchecker
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/libspell.uno.dylib'
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -register -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/libspell.uno.dylib'
ifndef PRODUCT_BUILD3
# Revoke HSQLDB driver
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/libhsqldb.dylib'
# Revoke JDBC driver
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/libjdbc.dylib'
# Revoke Java services
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; sh -e -c 'for i in LuceneHelpWrapper.jar ScriptFramework.jar ScriptProviderForBeanShell.jar ScriptProviderForJava.jar ScriptProviderForJavaScript.jar XMergeBridge.jar XSLTFilter.jar XSLTValidate.jar agenda.jar fax.jar form.jar letter.jar query.jar report.jar table.jar web.jar ; do "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c "vnd.sun.star.expand:\$$OOO_BASE_DIR/program/classes/$$i" ; done'
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; sh -e -c 'for i in juh.jar ; do "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c "vnd.sun.star.expand:\$$URE_INTERNAL_JAVA_DIR/$$i" ; done'
# Revoke Python services
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c 'vnd.openoffice.pymodule:mailmerge'
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c 'vnd.openoffice.pymodule:pythonscript'
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/pythonloader.uno.dylib'
endif
...
ifdef PRODUCT_BUILD3
	...
	cd "$(INSTALL_HOME)/package/Contents" ; rm -Rf README* program/LICENSE* program/open-url program/senddoc program/startup.sh program/unoinfo readmes share/readme
# Fix bug 3273 by not installing any OOo or ooo-build fonts
	cd "$(INSTALL_HOME)/package/Contents" ; rm -Rf "program/libAppleRemote.dylib" "program/libMacOSXSpell.dylib" "program/libavmediaQuickTime.dylib" "basis-link/program/libdtransaqua$(DLLSUFFIX).dylib" "program/fps_aqua.uno.dylib" "basis-link/program/liblwpft$(DLLSUFFIX).dylib" "share/fonts/truetype" "share/psprint"
ifdef PRODUCT_BUILD3
...
# Remove report toolbar from Base since reports require Java support
	...
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/etc/program/fundamentalrc" "program/fundamentalrc"
...
# Install report-builder.oxt
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/MacOS" ; sh -c -e 'JFW_PLUGIN_DO_NOT_CHECK_ACCESSIBILITY=1 ; export JFW_PLUGIN_DO_NOT_CHECK_ACCESSIBILITY ; unset CLASSPATH ; unset DYLD_LIBRARY_PATH ; for i in `find "$(PWD)/$(OO_BUILD_HOME)/solver/$${UPD}/$(UOUTPUTDIR)/bin" -type f -name "report-builder.oxt"` ; do rm -Rf "$(PWD)/$(INSTALL_HOME)/tmp" ; echo "yes" | ./unopkg.bin add --shared --verbose "$$i" -env:UserInstallation=file://"$(PWD)/$(INSTALL_HOME)/tmp" ; done ; rm -Rf "$(PWD)/$(INSTALL_HOME)/tmp"'
endif
...
ifdef PRODUCT_BUILD3
	...
	cd "$(PATCH_INSTALL_HOME)/package" ; sh -e -c 'for i in `find . -type f -name "*.bin" \! -name "soffice.bin"` "Contents/program/checknativefont" ; do codesign --force -s "$(CERTAPPIDENTITY)" --entitlements "$(PWD)/etc/package/Entitlements_inherit_only.plist" "$$i" ; done'
