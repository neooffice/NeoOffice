...
PRODUCT_DIR_PATCH_VERSION=$(subst $(SPACE),-,$(PRODUCT_PATCH_VERSION))$(PRODUCT_DIR_PATCH_VERSION_EXTRA)
...
NEO_TAG:=NeoOffice-2015_1
NEO_TAG2:=NeoOffice-2015_1_Free_Edition
NEO_TAG3:=NeoOffice-2015_1_Classic_Edition
