...
# With gcc 4.x, we must fully strip the soffice.bin executable
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/$(BUILD_HOME)/desktop/$(UOUTPUTDIR)/bin/soffice" "MacOS/soffice.bin" ; chmod a+x "MacOS/soffice.bin" ; strip "MacOS/soffice.bin"
	...
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/$(BUILD_HOME)/jvmfwk/$(UOUTPUTDIR)/bin/javavendors_ooo.xml" "basis-link/ure-link/share/config/javavendors.xml"
	...
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/$(BUILD_HOME)/rhino/$(UOUTPUTDIR)/misc/build/rhino1_5R4/build/rhino1_5R4/js.jar" "basis-link/program/classes"
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/$(BUILD_HOME)/vcl/$(UOUTPUTDIR)/class/vcl.jar" "basis-link/program/classes"
	mkdir -p "$(INSTALL_HOME)/package/Contents/basis-link/share/config/soffice.cfg/modules/scalc/accelerator/en-US"
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/sc/uiconfig/scalc/accelerator/en-US/default.xml" "basis-link/share/config/soffice.cfg/modules/scalc/accelerator/en-US/default.xml"
	mkdir -p "$(INSTALL_HOME)/package/Contents/basis-link/share/config/soffice.cfg/modules/sdraw/menubar"
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/sd/uiconfig/sdraw/menubar/menubar.xml" "basis-link/share/config/soffice.cfg/modules/sdraw/menubar/menubar.xml"
	mkdir -p "$(INSTALL_HOME)/package/Contents/basis-link/share/config/soffice.cfg/modules/sdraw/toolbar"
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/sd/uiconfig/sdraw/toolbar/toolbar.xml" "basis-link/share/config/soffice.cfg/modules/sdraw/toolbar/toolbar.xml"
	mkdir -p "$(INSTALL_HOME)/package/Contents/basis-link/share/config/soffice.cfg/modules/sglobal/menubar"
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/sw/uiconfig/sglobal/menubar/menubar.xml" "basis-link/share/config/soffice.cfg/modules/sglobal/menubar/menubar.xml"
	mkdir -p "$(INSTALL_HOME)/package/Contents/basis-link/share/config/soffice.cfg/modules/simpress/menubar"
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/sd/uiconfig/simpress/menubar/menubar.xml" "basis-link/share/config/soffice.cfg/modules/simpress/menubar/menubar.xml"
	mkdir -p "$(INSTALL_HOME)/package/Contents/basis-link/share/config/soffice.cfg/modules/simpress/toolbar"
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/sd/uiconfig/simpress/toolbar/toolbar.xml" "basis-link/share/config/soffice.cfg/modules/simpress/toolbar/toolbar.xml"
	mkdir -p "$(INSTALL_HOME)/package/Contents/basis-link/share/config/soffice.cfg/modules/swriter/menubar"
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/sw/uiconfig/swriter/menubar/menubar.xml" "basis-link/share/config/soffice.cfg/modules/swriter/menubar/menubar.xml"
...
ifeq ("$(PRODUCT_NAME)","NeoOffice")
	...
	chmod -Rf u+rw "$(INSTALL_HOME)/package/Contents/tmp"
	rm -Rf "$(INSTALL_HOME)/package/Contents/tmp"
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/basis-link/program" ; regcomp -revoke -r services.rdb -c "libMacOSXSpell$(DLLSUFFIX).dylib"
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/basis-link/program" ; regcomp -revoke -r services.rdb -c "classes/avmedia.jar"
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/basis-link/program" ; regcomp -revoke -r services.rdb -c "libavmediaQuickTime$(DLLSUFFIX).dylib"
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/basis-link/program" ; regcomp -register -r services.rdb -c "libavmediaquicktime.dylib"
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/basis-link/program" ; regcomp -revoke -r services.rdb -c "libdtransaqua$(DLLSUFFIX).dylib"
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/basis-link/program" ; regcomp -register -r services.rdb -c "libdtransjava$(DLLSUFFIX).dylib"
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/basis-link/program" ; regcomp -revoke -r services.rdb -c "fps_aqua.uno.dylib"
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/basis-link/program" ; regcomp -register -r services.rdb -c "fps_java.uno.dylib"
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/basis-link/program" ; regcomp -register -r services.rdb -c "libmozab2.dylib"
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/package/Contents/basis-link/program" ; regcomp -register -r services.rdb -c "updchk.uno.dylib"
	...
	cd "$(INSTALL_HOME)/package/Contents" ; rm -Rf "basis-link/program/libMacOSXSpell$(DLLSUFFIX).dylib" "basis-link/program/libavmediaQuickTime$(DLLSUFFIX).dylib" "basis-link/program/libdtransaqua$(DLLSUFFIX).dylib" "basis-link/program/libfps_aqua.uno.dylib"
	...
	cd "$(INSTALL_HOME)/package/Contents" ; sh -e -c 'for i in "basis-link/share/registry/data/org/openoffice/Setup.xcu" "basis-link/share/registry/data/org/openoffice/Office/Common.xcu" ; do sed "s#>$(OO_PRODUCT_NAME)<#>$(PRODUCT_NAME)<#g" "$${i}" | sed "s#>$(OO_PRODUCT_VERSION)<#>$(PRODUCT_VERSION)<#g" | sed "s#>$(OO_REGISTRATION_URL)<#>$(PRODUCT_REGISTRATION_URL)<#g" > "../../out" ; mv -f "../../out" "$${i}" ; done'
...
# Copy shared .oxt files
	cd "$(INSTALL_HOME)/$(PRODUCT_DIR_NAME)-$(PRODUCT_DIR_VERSION)-$(ULONGNAME).pkg/Contents/Resources" ; sh -c -e 'for i in `echo "$(PRODUCT_COMPONENT_MODULES)"` ; do if [ -f "$(PWD)/$$i/$(UOUTPUTDIR)/bin/$$i.oxt" ] ; then cp "$(PWD)/$$i/$(UOUTPUTDIR)/bin/$$i.oxt" . ; fi ; done'
...
# With gcc 4.x, we must fully strip the soffice.bin executable
	cd "$(PATCH_INSTALL_HOME)/package/Contents" ; cp "$(PWD)/$(BUILD_HOME)/desktop/$(UOUTPUTDIR)/bin/soffice" "MacOS/soffice.bin" ; chmod a+x "MacOS/soffice.bin" ; strip "MacOS/soffice.bin"
