...
# Product information
LIBO_PRODUCT_VERSION_FAMILY=7
LIBO_PRODUCT_NAME=LibreOfficeDev
LIBO_PRODUCT_VERSION=$(LIBO_PRODUCT_VERSION_FAMILY).4.1.2
PRODUCT_INSTALL_DIR_NAME=$(PRODUCT_NAME)
PRODUCT_VERSION_FAMILY=7.0
PRODUCT_VERSION_BASE=2023
PRODUCT_VERSION=$(PRODUCT_VERSION_BASE) Developer Build
