...
NEO_TAG:=NeoOffice-2020_Dev_Build
NEO_TAG2:=$(NEO_TAG)
NEO_TAG3:=$(NEO_TAG)
PRODUCT_MODULES = \
	unotest \
...
build.libo_patches: \
	build.libo_RepositoryExternal.mk_patch \
...
build.libo_RepositoryExternal.mk_patch: $(LIBO_PATCHES_HOME)/RepositoryExternal.mk.patch build.libo_checkout
ifeq ("$(OS_TYPE)","macOS")
