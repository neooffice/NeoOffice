...
build.neo_avmedia_patch build.neo_cpputools_patch build.neo_extensions_patch build.neo_fpicker_patch build.neo_lingucomponent_patch : build.neo_sal_patch
