...
NEO_TAG:=NeoOffice-3_3_Beta_2-1
...
# existing installation
	...
	cd "$(PATCH_INSTALL_HOME)/package/Contents" ; cp "$(PWD)/pyuno/$(UOUTPUTDIR)/lib/libpyuno.dylib" "$(PWD)/sfx2/$(UOUTPUTDIR)/lib/libsfx$(DLLSUFFIX).dylib" "$(PWD)/vcl/$(UOUTPUTDIR)/lib/libvcl$(DLLSUFFIX).dylib" "basis-link/program"
ifneq (,$(CERTSANDBOXTEAMIDENTIFIER))
