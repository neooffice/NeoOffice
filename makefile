...
ifdef PRODUCT_BUILD3
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/extensions/$(UOUTPUTDIR)/lib/libupdchk.dylib" "$(PWD)/extensions/$(UOUTPUTDIR)/lib/updchk.uno.dylib" "$(PWD)/pyuno/$(UOUTPUTDIR)/lib/libpyuno.dylib" "program"
endif
#	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/jvmfwk/$(UOUTPUTDIR)/lib/libjvmfwk.dylib.3" "$(PWD)/sal/$(UOUTPUTDIR)/lib/libuno_sal.dylib.3" "$(PWD)/salhelper/$(UOUTPUTDIR)/lib/libuno_salhelpergcc3.dylib.3" "$(PWD)/store/$(UOUTPUTDIR)/lib/libstore.dylib.3" "basis-link/ure-link/lib"
ifdef PRODUCT_BUILD3
...
ifeq ("$(PRODUCT_NAME)","NeoOffice")
	...
	chmod -Rf u+rw "$(INSTALL_HOME)/package/Contents/tmp"
	rm -Rf "$(INSTALL_HOME)/package/Contents/tmp"
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -revoke -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/libAppleRemote.dylib'
	...
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -registe -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/libavmediajava.dylib'
	...
	source "$(OO_ENV_JAVA)" ; setenv DYLD_LIBRARY_PATH "$(PWD)/$(INSTALL_HOME)/package/Contents/program:$$DYLD_LIBRARY_PATH" ; cd "$(INSTALL_HOME)/package/Contents/program" ; "$(PWD)/$(INSTALL_HOME)/package/Contents/program/regcomp" -registe -r services.rdb -c 'vnd.sun.star.expand:$$OOO_BASE_DIR/program/fps_java.uno.dylib'
...
# Fix bug 3273 by not installing any OOo or ooo-build fonts
	cd "$(INSTALL_HOME)/package/Contents" ; rm -Rf "program/libAppleRemote.dylib" "program/libMacOSXSpell.dylib" "program/libavmediaQuickTime.dylib" "basis-link/program/libdtransaqua$(DLLSUFFIX).dylib" "program/fps_aqua.uno.dylib" "basis-link/program/liblwpft$(DLLSUFFIX).dylib" "share/fonts/truetype" "basis-link/share/psprint"
ifdef PRODUCT_BUILD3
