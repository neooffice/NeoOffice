...
# LibreOffice 5.x shares LibreOffice 4.x preference files
PRODUCT_VERSION_FAMILY=4.0
PRODUCT_VERSION_BASE=2020 Beta
...
PRODUCT_MIN_OSVERSION_NAME=$(PRODUCT_MIN_OSVERSION) Mojave
PRODUCT_MAX_OSVERSION=10.15
PRODUCT_MAX_OSVERSION_NAME=$(PRODUCT_MAX_OSVERSION) Catalina
...
build.neo_configure: build.neo_instdir build.neo_workdir $(INSTDIR) $(WORKDIR)
	...
	echo "export gb_Side:=host" >> "$@"
	echo "include "'$$(dir $$(realpath $$(firstword $$(MAKEFILE_LIST))))../$(LIBO_BUILD_HOME)/config_$$(gb_Side).mk' >> "$@"
...
build.neo_dbaccess_patch: build.neo_xmloff_patch
...
# Remove Python files
	cd "$(INSTALL_HOME)/package/Contents" ; rm -Rf "Frameworks/LibreOfficePython.framework" "Frameworks/libpythonloaderlo.dylib" "Frameworks/pyuno.so" "Frameworks/libpyuno.dylib" "Resources/Scripts/python" "Resources/mailmerge.py" "Resources/msgbox.py" "Resources/officehelper.py" "Resources/pythonloader.py" "Resources/pythonloader.unorc" "Resources/pythonscript.py" "Resources/registry/pyuno.xcd" "Resources/uno.py" "Resources/unohelper.py" "Resources/services/pyuno.rdb" "Resources/services/scriptproviderforpython.rdb" "Resources/wizards/__init__.py" "Resources/wizards/agenda" "Resources/wizards/common" "Resources/wizards/document" "Resources/wizards/fax" "Resources/wizards/letter" "Resources/wizards/text" "Resources/wizards/ui"
endif
# Copy custom fonts
