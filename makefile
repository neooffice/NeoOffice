...
# Create the language pack installers
	...
	cd "$(INSTALL_HOME)/package/Contents" ; cp "$(PWD)/$(BUILD_HOME)/jvmfwk/$(UOUTPUTDIR)/bin/javaldx" "basis-link/ure-link/program/javaldx" ; chmod a+x "basis-link/ure-link/bin/javaldx"
...
ifeq ("$(PRODUCT_NAME)","NeoOffice")
	...
	cd "$(INSTALL_HOME)/package/Contents" ; rm -Rf "basis-link/program/libavmediaQuickTime$(DLLSUFFIX).dylib" "basis-link/program/libdtransaqua$(DLLSUFFIX).dylib" "basis-link/program/libfps_aqua.uno.dylib"
