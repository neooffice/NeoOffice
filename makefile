...
X11_PRODUCT_COMPONENT_MODULES=imagecapture
...
# Copy shared .oxt files
	source "$(OO_ENV_JAVA)" ; cd "$(INSTALL_HOME)/$(PRODUCT_DIR_NAME)-$(PRODUCT_DIR_VERSION)-$(ULONGNAME).pkg/Contents/Resources" ; sh -c -e 'for i in "$(PRODUCT_COMPONENT_MODULES)" ; do cp "$(PWD)/$$i/$(UOUTPUTDIR)/bin/$$i.oxt" . ; done'
...
# Copy shared .oxt files
	source "$(OO_ENV_JAVA)" ; cd "$(PATCH_INSTALL_HOME)/$(PRODUCT_DIR_NAME)-$(PRODUCT_DIR_VERSION)-$(PRODUCT_DIR_PATCH_VERSION)-$(ULONGNAME).pkg/Contents/Resources" ; sh -c -e 'for i in "$(PRODUCT_COMPONENT_MODULES)" ; do cp "$(PWD)/$$i/$(UOUTPUTDIR)/bin/$$i.oxt" . ; done'
