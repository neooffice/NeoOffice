...
# Mono libraries
	...
	source "$(OO_ENV_JAVA)" ; cp "$(BUILD_HOME)/solver/$${UPD}/$(UOUTPUTDIR)/bin/regcomp.bin" "$(PATCH_INSTALL_HOME)/$(PRODUCT_DIR_NAME)-$(PRODUCT_DIR_VERSION)-$(PRODUCT_DIR_PATCH_VERSION)-$(ULONGNAME).pkg/Contents/Resources/regcomp.bin" ; chmod a+x "$(PATCH_INSTALL_HOME)/$(PRODUCT_DIR_NAME)-$(PRODUCT_DIR_VERSION)-$(PRODUCT_DIR_PATCH_VERSION)-$(ULONGNAME).pkg/Contents/Resources/regcomp.bin"
