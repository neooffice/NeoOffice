...
build.neo_patches: build.ooo-build_all \
	...
	build.neo_sax_patch build.neo_oox_patch \
	build.neo_sc_patch \
	build.neo_sd_patch \
...
# Reregister libraries with modified services
# Reregister libcomp or else one of the previous libraries will reregister the
# com.sun.star.comp.comphelper.OPropertyBag service
