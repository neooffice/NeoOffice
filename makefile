...
CONFIGURE_EXTRA_OPTIONS:=--host=arm64-apple-darwin --build=$(TARGET_MACHINE)-apple-darwin --enable-python=no --with-build-platform-configure-options='--disable-odk --without-fonts --enable-python=no'
CROSS_COMPILE=true;
...
PRODUCT_VERSION_BASE=2021
PRODUCT_VERSION=$(PRODUCT_VERSION_BASE) Dev Build
...
PRODUCT_MIN_OSVERSION=11.1
PRODUCT_MIN_OSVERSION_NAME=$(PRODUCT_MAX_OSVERSION) Big Sur
PRODUCT_MAX_OSVERSION=11.1
...
NEO_TAG:=NeoOffice-2021_Dev_Build
NEO_TAG2:=$(NEO_TAG)
NEO_TAG3:=$(NEO_TAG)
PRODUCT_MODULES = \
	unotest \
