 ...
 *
 * Modified June 2010 by Patrick Luby. NeoOffice is distributed under
...
{
#ifdef USE_JAVA
	// Fix bug 3608 by recalculating the cell when the cell state looks like
	// it should have been set to dirty
	return bDirty || (bTableOpDirty && pDocument->IsInInterpreterTableOp()) || (aResult.GetResultError() == 0x7fff && aResult.GetCellResultType() == formula::svError && !aResult.GetToken());
#else	// USE_JAVA
