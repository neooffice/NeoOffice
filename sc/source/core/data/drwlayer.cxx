	...
	if (pPage)
	{
		...
		while (pObject)
		{
			...
			if ( !bSetVer && ( aObjRect.Bottom() < nStartY || aObjRect.Top() > nEndY ) )
				bFit = FALSE;
#ifdef USE_JAVA
			// Backport fix for OpenOffice.org bug 104716 from the following
			// OpenOffice.org revision of this file:
			// http://svn.services.openoffice.org/opengrok/xref/Current%20(trunk)/sc/source/core/data/drwlayer.cxx?r=276455%3A487320f6497b
