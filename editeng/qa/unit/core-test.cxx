...
void Test::testLineSpacing()
{
    ...
    CPPUNIT_ASSERT_EQUAL(SvxInterLineSpaceRule::Prop, pLSItem->GetInterLineSpaceRule());
    ...
    CPPUNIT_ASSERT_EQUAL(SvxInterLineSpaceRule::Prop, pLSItem2->GetInterLineSpaceRule());
