 ...
 *
 * Modified April 2013 by Patrick Luby. NeoOffice is distributed under
...
#if defined USE_JAVA && defined MACOSX
        if ( text.indexOf( OUString( RTL_CONSTASCII_USTRINGPARAM( "com.sun.star.loader.Java2" ) ) ) >= 0 || text.indexOf( OUString( RTL_CONSTASCII_USTRINGPARAM( "com.sun.star.loader.Python" ) ) ) >= 0 || text.indexOf( OUString( RTL_CONSTASCII_USTRINGPARAM( "javaloader.uno.dylib" ) ) ) >= 0 || text.indexOf( OUString( RTL_CONSTASCII_USTRINGPARAM( "vnd.sun.star.expand:$UNO_USER_PACKAGES_CACHE/uno_packages/" ) ) ) >= 0 )
        {
