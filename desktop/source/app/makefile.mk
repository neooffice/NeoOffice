...
.IF "$(X11_PRODUCT_DONATION_URL)" != ""
CDEFS += -DX11_PRODUCT_DONATION_URL='"$(X11_PRODUCT_DONATION_URL)"'
CDEFS+=-DDLLPOSTFIX=$(DLLPOSTFIX)
.ENDIF

.IF "$(X11_PRODUCT_WELCOME_URL)" != ""
CDEFS += -DX11_PRODUCT_WELCOME_URL='"$(X11_PRODUCT_WELCOME_URL)"'
CDEFS+=-DDLLPOSTFIX=$(DLLPOSTFIX)
.ENDIF
