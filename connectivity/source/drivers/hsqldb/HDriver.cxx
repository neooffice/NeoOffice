		...
		if ( acceptsURL(url) )
		{
			...
			if ( xDriver.is() )
			{
...
#ifdef USE_JAVA
                Sequence< PropertyValue > aProperties( 10 );
                sal_Int32 nPos = 0;
#else	// USE_JAVA
...
#ifdef USE_JAVA
                aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "storage_key" ) );
                aProperties[ nPos++ ].Value <<= sKey;
                aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "storage_class_name" ) );
                aProperties[ nPos++ ].Value <<= ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "com.sun.star.sdbcx.comp.hsqldb.StorageAccess" ) );
                aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "fileaccess_class_name" ) );
                aProperties[ nPos++ ].Value <<= ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "com.sun.star.sdbcx.comp.hsqldb.StorageFileAccess" ) );
#else	// USE_JAVA
...
#ifdef USE_JAVA
                aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "JavaDriverClass" ) );
                aProperties[ nPos++ ].Value <<= ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "org.hsqldb.jdbcDriver" ) );
                aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "JavaDriverClassPath" ) );
                aProperties[ nPos++ ].Value <<=
#else	// USE_JAVA
...
#ifdef USE_JAVA
                aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "IsAutoRetrievingEnabled" ) );
                aProperties[ nPos++ ].Value <<= sal_True;
                aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "AutoRetrievingStatement" ) );
                aProperties[ nPos++ ].Value <<= ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "CALL IDENTITY()" ) );
                aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "IgnoreDriverPrivileges" ) );
                aProperties[ nPos++ ].Value <<= sal_True;
#else	// USE_JAVA
...
#ifdef USE_JAVA
                aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "default_schema" ) );
                aProperties[ nPos++ ].Value <<= ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "true" ) );
#else	// USE_JAVA
...
#ifdef USE_JAVA
                aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "SystemProperties" ) );
                aProperties[ nPos++ ].Value <<= Sequence< NamedValue >( &aPermittedClasses, 1 );
#else	// USE_JAVA
				...
				if ( xProp.is() )
				{
					...
					{
#ifdef USE_JAVA
						aProperties.realloc( nPos + 1 );
						aProperties[ nPos ].Name = ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "readonly" ) );
						aProperties[ nPos++ ].Value <<= ::rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "true" ) );
#else	// USE_JAVA
