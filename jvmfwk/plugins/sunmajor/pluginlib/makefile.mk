...
# We cannot trust that the OOo build has honored the -source flag so don't
# use it here. This will will prevent loading of JVM's that cannot load all
# classes built by OOo.
.IF "$(GUIBASE)" == "java"
JAVAC:=$(JAVAC:s/ -source 1.4//)
.ENDIF
