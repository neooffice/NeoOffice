...
#ifdef USE_JAVA
            // Fix the following crashing bugs when opening .pptx files by
            // skipping NULL namespaces:
            // https://issues.apache.org/ooo/show_bug.cgi?id=107344
            // https://bugs.launchpad.net/ubuntu/+source/openoffice.org/+bug/374364
            if (!pPrefix)
                continue;
#endif	// USE_JAVA
