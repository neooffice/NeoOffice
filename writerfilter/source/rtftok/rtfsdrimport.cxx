...
#if SUPD == 310
    {
        uno::Reference<drawing::XShapes> xShapes(xDrawings->getDrawPage(), uno::UNO_QUERY);
        if (xShapes.is())
            m_aParents.push(xShapes);
    }
#else	// SUPD == 310
...
void RTFSdrImport::resolve(RTFShape& rShape, bool bClose, ShapeOrPict const shapeOrPict)
{
            ...
            i != rShape.aProperties.end(); ++i)
    {
        ...
        {
#if SUPD == 310
            aAny <<= msfilter::util::BGRToRGB((sal_uInt32)i->second.toInt32());
#else	// SUPD == 310
