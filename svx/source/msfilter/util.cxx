...
#if SUPD == 310
typedef std::hash_map< const char*, const char*, rtl::CStringHash, rtl::CStringEqual> CustomShapeTypeTranslationHashMap;
#else	// SUPD == 310
...
#if SUPD == 310
typedef std::hash_map< const char*, MSO_SPT, rtl::CStringHash, rtl::CStringEqual> DMLToVMLTranslationHashMap;
#else	// SUPD == 310
