...
#if SUPD == 310
	if( rType == ::getCppuType((const uno::Reference< text::XParagraphAppend >*)0) || rType == ::getCppuType((const uno::Reference< text::XParagraphAppend2 >*)0) )
        return uno::makeAny(uno::Reference< text::XParagraphAppend2 >(this));
	if( rType == ::getCppuType((const uno::Reference< text::XTextPortionAppend >*)0) || rType == ::getCppuType((const uno::Reference< text::XTextPortionAppend2 >*)0) )
        return uno::makeAny(uno::Reference< text::XTextPortionAppend2 >(this));
#else	// SUPD == 310
...
uno::Sequence< uno::Type > SAL_CALL SvxUnoTextBase::getStaticTypes() throw()
{
	...
	{
#if SUPD == 310
        maTypeSequence.realloc( 16 ); // !DANGER! keep this updated
#else	// SUPD == 310
...
#if SUPD == 310
        *pTypes++ = ::getCppuType(( const uno::Reference< text::XParagraphAppend2 >*)0);
#endif	// SUPD == 310
        *pTypes++ = ::getCppuType(( const uno::Reference< text::XTextPortionAppend >*)0);
#if SUPD == 310
        *pTypes++ = ::getCppuType(( const uno::Reference< text::XTextPortionAppend2 >*)0);
#endif	// SUPD == 310
		*pTypes++ = ::getCppuType(( const uno::Reference< lang::XServiceInfo >*)0);
		*pTypes++ = ::getCppuType(( const uno::Reference< lang::XTypeProvider >*)0);
		*pTypes++ = ::getCppuType(( const uno::Reference< lang::XUnoTunnel >*)0);
