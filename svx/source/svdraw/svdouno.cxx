 ...
 *    MA  02111-1307  USA
 *
 *    Modified November 2006 by Edward Peterlin. NeoOffice is distributed under
...
#ifdef USE_JAVA
						Region r = pOut->GetClipRegion();
						pOut->SetClipRegion();
						Color c = pOut->GetFillColor();
						Color l = pOut->GetLineColor();
