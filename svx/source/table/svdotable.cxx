...
#ifdef USE_JAVA
			if ( mpTableController )
			{
				CellPos aStart, aEnd;
				Rectangle aNativeHighlightRect( mpTableController->GetNativeHightlightColorRect() );
				aNativeHighlightRect.Intersection( aCellRect );
				if ( !aNativeHighlightRect.IsEmpty() )
				{
					Color aNativeHighlightColor = rXOut.GetOutDev()->GetSettings().GetStyleSettings().GetHighlightColor();
