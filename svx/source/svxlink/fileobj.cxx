...
*/
	...
	case FILETYPE_GRF:
		if( !bLoadError )
		{
			...
			{
#ifdef USE_JAVA
				// Fix document lockup bug reported in the following NeoOffice
				// forum topic by forcing any pending application events to
				// be dispatched before invoking xMed.Is():
