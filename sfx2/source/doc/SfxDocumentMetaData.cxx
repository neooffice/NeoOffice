...
static ::rtl::OUString CleanupNeoOfficeGenerator(::rtl::OUString aGenerator)
{
    ::rtl::OUString aRet(aGenerator);

    static const ::rtl::OUString aNeoOffice(RTL_CONSTASCII_USTRINGPARAM("NeoOffice/"));
