...
SfxApplication* SfxApplication::GetOrCreate()
{
    ...
    if ( !pApp )
    {
        ...
        if ( xWrp.is() )
            ...
            throw com::sun::star::uno::RuntimeException( rtl::OUString( RTL_CONSTASCII_USTRINGPARAM( "Couldn't create mandatory com.sun.star.office.OfficeWrapper service!" )), xWrp );
