...
#if SUPD == 310
    namespace sheet { struct TableFilterField; }
#else	// SUPD == 310
    namespace sheet { struct TableFilterField2; }
#endif	// SUPD == 310
    namespace sheet { class XDatabaseRange; }
#if SUPD == 310
    namespace sheet { class XSheetFilterDescriptor; }
#else	// SUPD == 310
...
{
#if SUPD == 310
    typedef ::std::vector< ::com::sun::star::sheet::TableFilterField > FilterFieldVector;
#else	// SUPD == 310
...
#if SUPD == 310
    void                finalizeImport( const ::com::sun::star::uno::Reference< ::com::sun::star::sheet::XSheetFilterDescriptor >& rxFilterDesc );
#else	// SUPD == 310
