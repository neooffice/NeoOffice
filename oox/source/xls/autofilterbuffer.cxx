...
ApiFilterSettings DiscreteFilter::finalizeImport( sal_Int32 nMaxCount )
{
    ...
    if( static_cast< sal_Int32 >( maValues.size() ) <= nMaxCount )
    {
...
#if SUPD == 310
            aSettings.appendField( false, FilterOperator_EQUAL, *aIt );
#else	// SUPD == 310
        ...
        if( mbShowBlank )
#if SUPD == 310
            aSettings.appendField( false, FilterOperator_EMPTY, OUString() );
#else	// SUPD == 310
...
#if SUPD == 310
        (mbPercent ? FilterOperator_TOP_PERCENT : FilterOperator_TOP_VALUES) :
        (mbPercent ? FilterOperator_BOTTOM_PERCENT : FilterOperator_BOTTOM_VALUES);
#else	// SUPD == 310
...
#if SUPD == 310
                bool bEqual = nOperator == FilterOperator_EQUAL;
                bool bNotEqual = nOperator == FilterOperator_NOT_EQUAL;
#else	// SUPD == 310
...
#if SUPD == 310
                        nOperator = bNotEqual ? FilterOperator_NOT_EMPTY : FilterOperator_EMPTY;
#else	// SUPD == 310
...
#if SUPD == 310
void AutoFilter::finalizeImport( const Reference< XSheetFilterDescriptor >& rxFilterDesc )
#else	// SUPD == 310
...
#if SUPD == 310
        ::std::vector< TableFilterField > aFilterFields;
#else	// SUPD == 310
...
#if SUPD == 310
            rxFilterDesc->setFilterFields( ContainerHelper::vectorToSequence( aFilterFields ) );
#else	// SUPD == 310
...
#if SUPD == 310
        Reference< XSheetFilterDescriptor > xFilterDesc( rxDatabaseRange->getFilterDescriptor(), UNO_QUERY_THROW );
#else	// SUPD == 310
