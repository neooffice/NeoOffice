...
#if SUPD == 310
void lcl_parseAdjustmentValue(comphelper::SequenceAsVector<drawing::EnhancedCustomShapeAdjustmentValue2>& rAdjustmentValues, const OString& rValue)
#else	// SUPD == 310
...
#endif	// SUPD == 310
{
    sal_Int32 nIndex = 0;
#if SUPD == 310
    drawing::EnhancedCustomShapeAdjustmentValue2 aAdjustmentValue;
#else	// SUPD == 310
...
#if SUPD == 310
void lcl_parseAdjustmentValues(comphelper::SequenceAsVector<drawing::EnhancedCustomShapeAdjustmentValue2>& rAdjustmentValues, const OString& rValue)
#else	// SUPD == 310
    ...
    while (bNotDone)
    {
        ...
        else
        {
            if (aLine == "AdjustmentValues")
            {
                ...
                {
#if SUPD == 310
                    comphelper::SequenceAsVector<drawing::EnhancedCustomShapeAdjustmentValue2> aAdjustmentValues;
#else	// SUPD == 310
